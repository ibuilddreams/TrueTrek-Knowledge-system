...
export default function CourseTierCard({ course, enrollmentStatus, onClick }) {
  ...
  return (
    <div
      ...
      className="border rounded-2xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer flex flex-col justify-between group focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-500/40 focus-visible:ring-offset-2 bg-white border-stone-200/80"
    >
      <div>
        <div className="flex items-center justify-between gap-2 border-b pb-3 mb-4 border-stone-100">
          <div className="flex items-center gap-2 min-w-0">
            <span className="font-mono text-xs font-bold px-2.5 py-1 rounded-md shrink-0 text-amber-750 bg-amber-50">
        ...
        <h3 className="text-lg font-serif font-semibold tracking-tight mb-2 transition-colors duration-250 line-clamp-2 text-stone-900 group-hover:text-amber-800">
          {course.title}
        </h3>
      ...
      <div className="flex items-center justify-between pt-4 border-t border-stone-100">
        ...
        <span className="text-xs font-semibold flex items-center gap-0.5 group-hover:gap-1.5 transition-all text-amber-700">
          View Course Details
