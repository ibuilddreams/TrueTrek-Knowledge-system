...
import {
  Lock, GraduationCap, Plus, TrendingUp, BookMarked, Users, BookOpenCheck, FileText,
} from 'lucide-react';
  ...
  return (
    <div id="teacher-portal-view" className="py-10 px-4 sm:px-6 md:px-10 max-w-7xl mx-auto min-h-[85vh] font-sans">
      ...
      <TabTransition activeKey={activeTab}>
        ...
        {activeTab === 'students' && (
          <EnrollmentScoresTab students={students} setStudents={setStudents} onEditStudent={handleOpenEdit} />
        )}
