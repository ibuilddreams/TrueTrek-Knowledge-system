...
function TeacherChoiceRow({ choice, onMarkCorrect, onEdit, onDelete, isMutating }) {
...
export default function TeacherQuestionChoicesModal({ isOpen, onClose, question, quizId }) {
