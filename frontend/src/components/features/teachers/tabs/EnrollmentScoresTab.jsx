      ...
      <div className="bg-white border border-stone-200 p-5 rounded-2xl shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="relative flex-grow max-w-md">
          ...
          <input
            ...
            className="w-full bg-stone-50 border border-stone-200/90 rounded-xl pl-10 pr-4 py-2.5 text-sm text-stone-800 placeholder:text-stone-400 focus:outline-none focus:border-amber-600 transition"
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <div className="flex items-center gap-1.5 bg-stone-50 border border-stone-200/90 rounded-xl px-3 py-1.5">
            ...
            <select
              ...
              className="bg-transparent text-sm font-mono text-stone-605 border-none focus:outline-none focus:ring-0 cursor-pointer"
            >
          ...
          <span className="text-[11px] font-mono uppercase px-2.5 py-1 bg-stone-50 border border-stone-200 text-stone-500 rounded-lg">
      ...
      <div className="bg-white border border-stone-200 rounded-2xl shadow-sm overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-stone-50 text-stone-400 font-mono text-[11px] uppercase tracking-wider border-b border-stone-200/80">
              ...
              {filteredStudents.length > 0 ? (
                    ...
                    >
                      <td className="py-4.5 px-6">
                        <div className="flex items-center gap-3">
                          <div className="w-9 h-9 rounded-full bg-stone-100 border border-stone-200 flex items-center justify-center font-bold text-stone-700 text-sm shadow-inner shrink-0">
                      ...
                      <td className="py-4.5 px-6 font-mono text-xs text-stone-500">
                ...
                <tr>
                  <td colSpan={7} className="py-12 text-center text-stone-400 font-light">
                    <span className="block font-mono text-sm uppercase text-amber-700 mb-1">
                      NO RECORDS FOUND
                    </span>
              ...
              {detailStatus === "succeeded" && studentDetail && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <h4 className="text-sm font-mono uppercase tracking-wider text-stone-400 font-bold">
                      Enrolled Courses
                    </h4>
        ...
        {quickViewStudent && (
          ...
          >
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 bg-stone-50 p-3 rounded-xl border border-stone-100 font-mono text-[11px]">
                <div>
              ...
              <div className="pt-3 border-t border-stone-100 flex gap-2">
                <button
                  ...
                  className="flex-1 py-2 bg-stone-900 hover:bg-stone-850 text-white font-mono text-[11px] uppercase font-bold rounded-lg transition text-center"
                >
                  Open Full Dossier
                </button>
                <button
                  type="button"
                  onClick={() => setQuickViewStudent(null)}
                  className="px-4 py-2 bg-white border border-stone-200 hover:bg-stone-50 text-stone-650 font-mono text-[11px] uppercase font-semibold rounded-lg transition"
                >
                  Close
                </button>
              </div>
