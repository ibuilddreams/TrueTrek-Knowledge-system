        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          >
            {recentActivities.length === 0 ? (
              ...
              <ul className="space-y-2 max-h-90 overflow-y-auto pr-1.5 -mr-1.5 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-line [&::-webkit-scrollbar-thumb]:rounded-full [&:hover::-webkit-scrollbar-thumb]:bg-muted/40">
          ...
          >
            {progressSummary.length === 0 ? (
              ...
              <ul className="space-y-2.5 max-h-90 overflow-y-auto pr-1.5 -mr-1.5 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-line [&::-webkit-scrollbar-thumb]:rounded-full [&:hover::-webkit-scrollbar-thumb]:bg-muted/40">
