    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <label className="flex items-center gap-2 text-sm font-mono text-muted mt-6 sm:mt-0 sm:self-end sm:pb-3.5">
            <input
              type="checkbox"
          ...
          <label className="flex items-center gap-2 text-sm font-mono text-muted sm:self-end sm:pb-3.5">
            <input
              type="checkbox"
        ...
        <div>
          ...
          <button
            ...
            onClick={addOption}
            disabled={isSubmitting}
            className="mt-3 w-full flex items-center justify-center gap-2 py-3 border border-dashed border-line rounded-lg text-xs font-mono uppercase tracking-wider text-muted hover:border-pine hover:text-pine transition cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
          >
