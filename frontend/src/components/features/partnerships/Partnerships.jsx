...
export default function Partnerships() {
  ...
  return (
    <div id="partnerships-container" className="cn-page-bg py-16 px-6 min-h-screen">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          <div className="bg-paper border border-line p-6 rounded-card shadow-soft hover:shadow-elevated hover:-translate-y-1 transition-all duration-300">
            <div className="w-12 h-12 rounded-xl bg-gold/15 text-[#8a6f2e] flex items-center justify-center mb-5">
              <Landmark className="w-6 h-6" />
            </div>
            <h3 className="text-lg font-serif font-light text-ink mb-2">Institutional White-Labeling</h3>
          ...
          <div className="bg-paper border border-line p-6 rounded-card shadow-soft hover:shadow-elevated hover:-translate-y-1 transition-all duration-300">
            <div className="w-12 h-12 rounded-xl bg-sage text-moss flex items-center justify-center mb-5">
              <HeartPulse className="w-6 h-6" />
            </div>
            <h3 className="text-lg font-serif font-light text-ink mb-2">Real-time Safety Indicators</h3>
            <p className="text-muted text-xs leading-relaxed font-light">
          ...
          <div className="bg-paper border border-line p-6 rounded-card shadow-soft hover:shadow-elevated hover:-translate-y-1 transition-all duration-300">
            <div className="w-12 h-12 rounded-xl bg-sky text-blue flex items-center justify-center mb-5">
              <Shield className="w-6 h-6" />
            </div>
            <h3 className="text-lg font-serif font-light text-ink mb-2">Athletic & Scholastic Shield</h3>
            <p className="text-muted text-xs leading-relaxed font-light">
        ...
        <div className="bg-pine text-paper rounded-panel p-6 md:p-10 border border-white/10 shadow-xl overflow-hidden relative">
          <div className="absolute -right-10 -bottom-10 w-96 h-96 rounded-full bg-gold/10 blur-[100px] pointer-events-none"></div>

          <div className="flex flex-wrap items-center gap-2 mb-8 border-b border-white/10 pb-5">
            <Calculator className="text-gold w-5 h-5" />
            <h3 className="text-xl md:text-2xl font-serif font-light text-paper">
            ...
            <div id="sim-controls" className="lg:col-span-7 space-y-8">
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <label className="text-xs font-sans text-paper/60 uppercase tracking-widest font-medium">Student Body Count</label>
                  <span className="text-gold font-sans text-sm font-semibold">{studentCount} Students</span>
                </div>
                <input
                ...
                />
                <div className="flex justify-between text-[10px] text-paper/50 font-sans mt-1">
                  <span>50</span>
                  <span>1,500</span>
              ...
              <div>
                <label className="text-xs font-sans text-paper/60 uppercase tracking-widest font-medium block mb-3">Licensing Level</label>
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`p-3.5 rounded-xl border text-left transition ${
                        licenceTier === tier.id
                          ? 'bg-gold/12 border-gold text-paper'
                          : 'bg-black/20 border-white/10 text-paper/60 hover:bg-white/5'
                      }`}
                    >
                      <p className="text-xs font-semibold text-paper">{tier.title}</p>
                      <p className="text-[10px] font-sans mt-1 text-gold">{tier.price}</p>
                    </button>
                  ))}
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <label className="text-xs font-sans text-paper/60 uppercase tracking-widest font-medium">Counseling Ratio Density</label>
                  <span className="text-gold font-sans text-sm font-semibold">1 counselor : {counselorDensity} students</span>
                </div>
                <input
              ...
              <div className="bg-black/20 p-4 rounded-xl border border-white/10">
                <p className="text-[9px] font-sans uppercase tracking-widest font-medium text-gold mb-1">Licence Scope Detail</p>
                <p className="text-xs text-paper/70 leading-relaxed font-light">{simulatorMetrics.coverageText}</p>
              </div>
            </div>

            {/* Right Side: Outputs Showcase */}
            <div id="sim-outputs" className="lg:col-span-5 bg-black/20 rounded-panel p-6 border border-white/10 flex flex-col justify-between min-h-[350px]">
              <div className="space-y-6">
                <div>
                  <span className="text-paper/60 text-xs font-sans tracking-widest uppercase font-medium block mb-1">Estimated Annual Fee</span>
                  <div className="flex items-baseline gap-2">
                    <span className="text-3xl md:text-4xl font-serif font-light text-gold">${simulatorMetrics.annualLicensing}</span>
                    <span className="text-paper/60 text-xs font-sans">USD/Yr</span>
                  </div>
                </div>
                ...
                <div className="border-t border-white/10 pt-5 space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-sans text-sm font-semibold text-mint">{simulatorMetrics.complianceScore}%</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-sans text-sm font-semibold text-mint">{simulatorMetrics.riskReduction}%</span>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-white/10 pt-6 mt-6">
                <button
                  ...
                  className="w-full bg-paper hover:bg-white text-ink font-semibold py-3 px-4 rounded-full text-xs tracking-wider uppercase transition shadow-md"
                >
                  Request Licensing Briefing
                </button>
                <p className="text-center text-[10px] text-paper/50 mt-3">
