...
const PRODUCTS = [
  {
    ...
    price: 4500,
    description:
      "Permanent institutional organization-wide clearance for all 11 TrueTrek Learning tiers, compliance slide decks, and handbook covenants.",
    details:
      "Includes direct annual curriculum alignment updates, FERPA certification blueprints, and print-ready master vectors for classroom deployment.",
    image:
  ...
  },
  {
    ...
    price: 450,
    description:
      "High-yield Simple Agreement for Future Equity (SAFE) covenants optimized by corporate specialists to prevent predatory early dilution.",
    details:
      "Documents include side-letter covenants, standard 20% discount provisions, customized valuation caps, and comprehensive board resolution templates.",
    image:
  ...
  },
  {
    ...
    price: 299,
    description:
      "Amanda Ross, Esq. blueprint mapping athletic team uniforms guidelines, beverage exclusivity strategies, and state disclosure forms.",
    details:
      "Features 15 annotated real-world clauses, boilerplate letter templates to send to institutional compliance departments, and trademark protection filings checklists.",
    image:
  ...
  },
  {
    ...
    price: 120,
    description:
      'Ultra-light high-durability mesh practice jersey optimized for body heat regulation. Prominently features the signature "TTL" emblem.',
    details:
      "Tailored fit using high-wicking synthetic fiber blend, laser-cut ventilation ports, and high-visibility light reflective safety decals.",
    image:
  ...
  },
  {
    ...
    price: 45,
    description:
      "Medical-grade zero-pressure light shielding design tailored for critical REM optimization sessions during high-pressure training drills.",
    details:
      "Equipped with organic memory foam contours, sound-attenuating elastic covenants, and micro-aerated breathable natural fiber linings.",
    image:
  ...
  },
  {
    ...
    price: 65,
    description:
      "High-contrast raw print journal for detailing daily strategic dilemmas, tactical cap-table allocations, and mental models logging.",
    details:
      "200 pages of premium 120gsm heavy stock, textured linen hardback binding with gold-debossed typography and matching silk ribbon placeholders.",
    image:
...
export default function MerchantStore() {
  ...
  const handleConsultAdvisor = async () => {
    ...
    const advisor =
      ADVISOR_PERSONAS.find((a) => a.id === selectedAIAdvisorId) ||
      ADVISOR_PERSONAS[0];
...
- Keep your output beautifully formatted in professional Markdown with solid headers. Avoid filler text.`;
  ...
  const deliveryFee =
    cart.length === 0
      ? 0
      : cart.every((item) => item.product.isDigital)
        ? 0
        : 18.5;
  ...
  return (
    <div
      ...
      className="min-h-screen bg-[#faf9f6] text-stone-900 pb-24"
    >
      {/* Dynamic Header */}
      <div
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center sm:text-left flex flex-col sm:flex-row justify-between items-center gap-6">
          <div className="space-y-3">
            ...
            <p className="text-stone-450 text-xs md:text-sm font-light max-w-xl leading-relaxed">
              Equip your academic program, secure pre-vetted compliance contract
              binders, and purchase elite high-performance athletic gear vetted
              by scouts.
            </p>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-6 mt-12">
        ...
        <div className="bg-stone-100 border border-stone-200 rounded-2xl p-4 mb-10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-stone-700 font-sans leading-relaxed">
            ...
            Use{" "}
            <code className="bg-stone-200 text-stone-900 border border-stone-200 px-1.5 py-0.5 rounded font-mono text-xs font-semibold">
              LEGACY20
            </code>{" "}
            for 20% off high-tier licenses or{" "}
            <code className="bg-stone-200 text-stone-900 border border-stone-200 px-1.5 py-0.5 rounded font-mono text-xs font-semibold">
              COMPLIANCE
            </code>{" "}
            ...
            <div className="flex items-start gap-4 border-b border-stone-800 pb-5">
              ...
              <div className="space-y-1 text-left">
                ...
                <p className="text-xs text-stone-400 font-light leading-relaxed">
                  Connect your personal scenarios directly with council advisors
                  to formulate targeted pathway acquisitions. Get professional
                  feedback on compliance rules and purchase-ready materials.
                </p>
              </div>
            </div>
                        ...
                        <div className="border-t border-stone-850 pt-5 mt-4 space-y-4">
                          <div className="flex items-center gap-2 text-left">
                            ...
                            <h4 className="text-xs font-mono font-bold uppercase tracking-wider text-amber-500">
                              RECOMMENDED ACQUISITION PATHWAY ASSETS (
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-stone-200 pb-5 mb-10">
          <div className="flex flex-wrap items-center gap-2">
            {["All", "Licensing", "Digital Guides", "Apparel & Gear"].map(
              (cat) => (
                <button
              ...
              <div>
                ...
                <div className="p-6 space-y-3">
                  <div className="flex justify-between items-start gap-2">
                    <h3 className="text-base font-serif font-bold tracking-tight text-stone-900 group-hover:text-amber-800 transition-colors">
                      {product.name}
                    </h3>
                  </div>
                ...
                <div className="flex-grow overflow-y-auto p-6 space-y-6">
                  {cart.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-20 text-center space-y-4">
                      ...
                      <div>
                        <p className="text-xs font-bold text-stone-800">
                          Your acquisition ledger is empty
                        </p>
                        <p className="text-[11px] text-stone-500 mt-1 max-w-[240px] leading-relaxed mx-auto">
                          Browse our elite educational frameworks and physical
                          training support gear to assemble your kit.
                        </p>
                      </div>
                      <button
                        onClick={() => setIsCartOpen(false)}
                    ...
                    <div className="space-y-4">
                      <p className="text-xs uppercase font-mono text-stone-400 tracking-wider">
                        Reviewing Products Under Negotiation
                      </p>

                      {cart.map((item) => (
                        <div
                          key={item.product.id}
                          className="flex gap-4 p-4 rounded-xl border border-stone-200 bg-stone-50"
                        >
                          <img
                  ...
                  {cart.length > 0 && (
                    <div className="border-t border-stone-200 pt-5 mt-6">
                      <label className="text-[10px] font-mono uppercase text-stone-400 tracking-widest block mb-2">
                        Apply Compliance Promotion Code
                      </label>
                      <div className="flex gap-2">
                        ...
                        <button
                          onClick={applyCoupon}
                          className="bg-stone-900 hover:bg-stone-800 text-white font-mono text-xs uppercase tracking-widest px-4 rounded-xl font-bold"
                        >
                          Verify
                        </button>
                      </div>
                      ...
                      {appliedDiscount && (
                        <div className="bg-emerald-50 text-emerald-850 px-3.5 py-2.5 rounded-xl border border-emerald-150 text-[11px] font-mono flex items-center justify-between mt-2">
                          <span className="flex items-center gap-1 text-emerald-800 font-bold">
                            ...
                            CODE STATUS ACTIVE ({appliedDiscount.code} -{" "}
                            {appliedDiscount.percent}% off)
                          </span>
                          <button
                            onClick={removeCoupon}
                            className="text-emerald-700 hover:text-stone-900 underline uppercase text-[10px] font-bold"
                          >
                            Remove
                          </button>
                        </div>
                      ...
                      {couponError && (
                        <p className="text-orange-600 text-[10px] font-mono mt-1.5">
                          {couponError}
                        </p>
                      )}
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2 text-xs font-mono">
                        ...
                        <div className="flex justify-between text-stone-500">
                          ...
                          <span>
                            $
                            {regulatoryTax.toLocaleString(undefined, {
                              minimumFractionDigits: 2,
                            })}
                          </span>
                        </div>
                      ...
                      <form
                        ...
                        className="space-y-3.5 border-t border-stone-200 pt-4 mt-2"
                      >
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            <label className="text-[9px] font-mono text-stone-450 block uppercase tracking-wide">
                              Steward Full Name
                            </label>
                            <input
                              type="text"
                        ...
                        <div>
                          <label className="text-[9px] font-mono text-stone-450 block uppercase tracking-wide">
                            Acquisition Card Number (Simulated)
                          </label>
                          <div className="relative">
                  ...
                  {checkoutStep === "processing" && (
                    <div className="flex flex-col items-center justify-center py-10 space-y-4">
                      ...
                      <div className="text-center space-y-1">
                        <p className="text-xs font-mono font-bold uppercase tracking-wider text-stone-850 animate-pulse">
                          Securing Ledger Signatures
                        </p>
                        <p className="text-[10px] text-stone-500 font-mono">
                          Routing through Federal & Academy clearing gateways...
                        </p>
                      </div>
                    </div>
                  )}
                      ...
                      <div className="bg-stone-900 text-white p-5 rounded-2xl space-y-4 relative overflow-hidden text-center border border-stone-800">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-[10px] font-mono text-emerald-400 uppercase tracking-widest">
                            CLEARANCE STICKER: {generatedInvoiceId}
                          </p>
                        </div>

                        <div className="bg-stone-950 p-4 rounded-xl text-left border border-stone-850 space-y-2 text-xs font-mono">
                          <p className="text-[9px] text-[#faece1] font-bold uppercase tracking-wider">
                            Acquisition Assets Receipt
                          </p>
                        ...
                        {Object.keys(generatedLicenseKeys).length > 0 && (
                          <div className="bg-stone-950 p-4 rounded-xl text-left border border-stone-850 space-y-3">
                            <p className="text-[9px] text-amber-400 font-bold uppercase tracking-widest font-mono">
                              Dynamic Digital Product Licenses
                            </p>
                            {purchasedProducts
                              .filter((item) => item.product.isDigital)
                              .map((item, index) => (
                                <div key={index} className="space-y-1 text-xs">
                                  <p className="text-[10px] text-stone-205 font-bold">
                                    {item.product.name}
                                  </p>
                        ...
                        <p className="text-[9px] text-stone-400 leading-normal leading-relaxed">
                          Receipt, legal disclosure logs, and transport details
                          dispatched to{" "}
                          <strong className="text-stone-300 font-mono">
                            {billingEmail}
                          </strong>
                          . Verification hashes matched perfectly!
                        </p>
