...
export default function LessonCompleteButton({ lesson, courseId, canInteract }) {
  ...
  if (isCompleted) {
    return (
      <span
        className="inline-flex items-center gap-1.5 px-3.5 py-2 border text-xs font-mono uppercase tracking-wider rounded-lg bg-emerald-50 border-emerald-100 text-emerald-700"
      >
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 px-3.5 py-2 disabled:opacity-40 disabled:cursor-not-allowed text-xs font-mono uppercase tracking-wider rounded-lg transition bg-pine hover:bg-moss text-paper"
    >
