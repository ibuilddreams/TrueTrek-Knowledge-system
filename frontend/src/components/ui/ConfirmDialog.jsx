    ...
    >
      <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-3 mt-2">
        <button
          ...
          className={`px-4 py-3 ${size === "lg" ? "text-sm" : "text-xs"} font-semibold font-sans rounded-lg tracking-wider transition-colors duration-150 flex items-center justify-center gap-2 border shadow-sm disabled:opacity-60 disabled:cursor-not-allowed bg-porcelain hover:bg-paper text-ink border-line`}
        >
          Cancel
        </button>
        <button
