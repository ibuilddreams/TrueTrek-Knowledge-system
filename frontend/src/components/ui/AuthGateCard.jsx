...
export default function AuthGateCard({ id, icon, title, subtitle, children, size = "base" }) {
  return (
    ...
    >
      <div className="tt-enter tt-interactive w-full max-w-md p-8 sm:p-10 rounded-panel shadow-elevated relative overflow-hidden bg-paper border border-line">
        ...
        <div className="text-center mb-8">
          <IconBadge
            ...
            size="w-12 h-12"
            iconSize="w-6 h-6"
            className="tt-float mb-4 rounded-xl border bg-pine/10 text-pine border-pine/20"
            center
          />
