...
from .views import (
    ...
    QuizDescriptionSuggestionsView,
    QuizDetailView,
    QuizListCreateView,
...
urlpatterns = [
    ...
    path(
        "suggestions/title/",
        QuizTitleSuggestionsView.as_view(),
        name="quiz-title-suggestions",
    ),
    path(
        "suggestions/description/",
        QuizDescriptionSuggestionsView.as_view(),
        name="quiz-description-suggestions",
    ),
