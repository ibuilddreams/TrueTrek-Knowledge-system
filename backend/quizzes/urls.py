...
urlpatterns = [
    ...
    path(
        "<int:quiz_id>/students/<int:student_id>/grant-attempt/",
        QuizGrantAttemptView.as_view(),
        name="quiz-grant-attempt",
    ),
    ...
    path("<int:quiz_id>/self-retry/", QuizSelfRetryView.as_view(), name="quiz-self-retry"),
    path(
